                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="index.html" class="navbar-brand nav-link">
                            <img alt="branding logo" src="{{ URL::asset('/app-assets/images/logo/robust-logo-light.png') }}" data-expand="{{ URL::asset('/app-assets/images/logo/robust-logo-light.png') }}" data-collapse="{{ URL::asset('/app-assets/images/logo/robust-logo-small.png') }}" class="brand-logo">
                        </a>
                    </li>
                    ...
                    <ul class="nav navbar-nav float-xs-right">
                      <li class="dropdown dropdown-language nav-item"><a id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle nav-link"><i class="flag-icon flag-icon-gb"></i><span class="selected-language">English</span></a>
                        <div aria-labelledby="dropdown-flag" class="dropdown-menu">
                          ...
                          <a href="#" class="dropdown-item">
                            <i class="flag-icon flag-icon-ph"></i> Filipino
                          </a>
                        </div>
                      </li>
                      ...
                      <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link">
                          <span class="avatar avatar-online">
                              <img src="{{ URL::asset('/app-assets/images/portrait/small/avatar-s-1.png') }}" alt="avatar"><i></i>
                          </span>
                          <span class="user-name">@yield('username')</span></a>
                          <div class="dropdown-menu dropdown-menu-right">
                              <a href="#" class="dropdown-item">
                                  <i class="icon-head"></i> @lang('messages.EditProfile')
                              </a>
                              <a href="#" class="dropdown-item">
                                  <i class="icon-power3"></i> @lang('messages.Logout')
                              </a>
                          </div>
                      </li>
                    </ul>
